                ...
                <div class="col-md-9 reviews-grids">
                    <div class="review">
                        ...
                        <div class="review-info">
                            ...
                            <p class="info">Композитор:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Джерри Голдсмит</p>
                            <p class="info">Продюсер:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Артур П. Джейкобс, Морт Абрахамс</p>
                    ...
                    <div class="story-review">
                        <h4>Описание:</h4>
                        <p>В 3978 году космический корабль землян терпит крушение на далекой планете. Выжившие в катастрофе астронавты удивляются, как она похожа на их дом. Вскоре они узнают, что планета населена разумными обезьянами и деградировавшими до животного состояния людьми.
                            Обезьяны захватывают астронавтов в плен, но после продолжительных пыток один из них совершает побег вместе с симпатичной девушкой-шимпанзе, которая открывает ему страшные тайны.</p>
                    </div>
